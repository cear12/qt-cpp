...
//
// connect(source, &DataSource::dataChanged, observer1,
// &Observer::onDataChanged); connect(source, &DataSource::milestone, observer2,
// &Observer::onMilestone); See examples/console_demo.cpp for a runnable version
// of this.
