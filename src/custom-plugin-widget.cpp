...
CustomWidgetPlugin::CustomWidgetPlugin(QObject* parent) : QObject(parent), m_initialized(false) {}
...
QString CustomWidgetPlugin::group() const { return QLatin1String("My Widgets"); }

QString CustomWidgetPlugin::includeFile() const { return QLatin1String("qtcpp/custom-plugin-widget.h"); }

QString CustomWidgetPlugin::name() const { return QLatin1String("CustomWidget"); }

QString CustomWidgetPlugin::toolTip() const { return QLatin1String("A simple custom widget"); }

QString CustomWidgetPlugin::whatsThis() const {
    return QLatin1String("A minimal QWidget subclass, wrapped as a Qt Designer plugin.");
}

QWidget* CustomWidgetPlugin::createWidget(QWidget* parent) { return new CustomWidget(parent); }
